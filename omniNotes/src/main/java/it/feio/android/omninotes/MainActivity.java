...
public class MainActivity extends BaseActivity implements
  ...
  protected void onPostCreate(@Nullable Bundle savedInstanceState) {
    ...
    if (!launchIntroIfRequired() && AppVersionHelper.isAppUpdated(getApplicationContext()) && !BuildHelper.isDebugBuild()) {
  ...
  private void showChangelogAndUpdateCurrentVersion() {
    showChangelog(this);
    AppVersionHelper.updateAppVersionInPreferences(getApplicationContext());
  }
